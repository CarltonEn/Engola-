...
class TestImports(unittest.TestCase):
    def test_all_modules_import(self):
        ...
        from routers import auth, career, chat, google_oauth, health, media, memory, permissions, uganda, voice  # noqa
    ...
    def test_main_registers_all_routers(self):
        ...
        for mod in (auth, career, chat, google_oauth, health, media, memory, permissions, uganda, voice):
